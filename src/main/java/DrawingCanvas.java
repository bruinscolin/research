...
public class DrawingCanvas extends JComponent {
    ...
    public void addSector(Point center, double radius, double start_angle, double end_angle, double c) {
        ...
        double[] sector = new double[] { center.getDrX(), center.getDrY(), radius, start_angle, extent, c };
        ;
        sectors.add(sector);
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (Circle c : circles) {
            ...
            outlineEllipseFromCenter(draw_x, draw_y, 2 * c.getRadius() * scale, 2 * c.getRadius() * scale, g2d,
                    Color.BLUE);
        ...
        for (Point p : points) {
            ...
            drawEllipseFromCenter(scaled_x, scaled_y, 10, 10, g2d, c);
        ...
        for (double[] sector : sectors) {
            ...
            double color_position = sector[5];
            ...
            // sector.setArcByCenter(center.getDrX(), center.getDrY(), radius, startAngle,
            // extent, Arc2D.PIE);
        ...
        drawEllipseFromCenter(target_scaled_x, target_scaled_y, 10, 10, g2d, hot_pink);
